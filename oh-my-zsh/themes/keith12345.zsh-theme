...
PROMPT='%{$fg_no_bold[blue]%}%n%{$fg_no_bold[magenta]%}•%{$fg_no_bold[green]%}%3~$(git_prompt_info)%{$fg_no_bold[magenta]%}${NEWLINE} » '
...
ZSH_THEME_GIT_PROMPT_DIRTY="%{$fg_no_bold[cyan]%}⚡%{$fg_no_bold[cyan]%}) "
